const API_KEY = "719d78205f254b9aae4042a2bb189a60";
...
function bindData(articles) {
    ...
    articles.forEach((article) => {
        ...
        if (document.body.classList.contains("dark-theme")) {
            cardClone.firstElementChild.classList.add("dark-theme");
        }
...
function toggleTheme() {
    ...
    const navLinks = document.querySelector(".nav-links");
    if (document.body.classList.contains("dark-theme")) {
        navLinks.classList.add("dark-theme");
    } else {
        navLinks.classList.remove("dark-theme");
    }
